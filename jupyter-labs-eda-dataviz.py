...
# Plotting scatter plot for PayloadMass vs. Orbit
plt.figure(figsize=(12,8))
...
# Use the function to extract the year from the Date column
...
# Calculating the average success rate by year
...
# Convert only those columns to float64
